...
export const routes: MTBRoute[] = [
  ...
  },
  {
    ...
    type: "circular",
    summary: "La ruta reina de E-nduro Singletracks. Enduro mtb en su sentido más inclusivo y montañero.",
    description: "Coronel Perdido es para muchos la ruta reina de E-nduro Singletracks, una propuesta de enduro mtb en su sentido más inclusivo y montañero, y también duro. Esto incluye diferentes tramos de PORTEO, o al menos de empujar la bici. No son largos pero están ahí. Es una ruta BTT impactante, plagada de sendas, en un ambiente excepcional. No puede dejar a nadie indiferente, si bien tampoco será del gusto de todo el mundo, ya que aunque incorpora bajadas rápidas y muy divertidas, resulta una ruta DURA y montañera, cosa que no siempre gusta a los más motivados por los rápidos descensos. Otra dificultad añadida es la navegación. Parte de la ruta se ha construido sobre antiguas vías pecuarias, cuya anchura llega a los 75 m y en las que el camino es poco evidente. Incorpora uno de los Top Tracks más espectaculares de E-nduro Singletracks: Coronel Trumel, con parte de otro que no le va a la zaga, Mundo Perdido, y con un feliz retorno a casa como es Red Hot.",
    distanceKm: 44.8,
    elevationGainM: 1500,
    elevationLossM: 1500,
    maxAltitudeM: 1250,
