...
export const metadata: Metadata = {
  title: {
    default: "Morella Singletracks | Rutas MTB & Enduro",
    template: "%s | Morella Singletracks"
  },
  ...
  authors: [{ name: "Morella Singletracks" }],
  creator: "Morella Singletracks",
  openGraph: {
    type: "website",
    locale: "es_ES",
    url: "https://ignacioimatik-web.github.io/levo",
    siteName: "Morella Singletracks",
    title: "Morella Singletracks | Rutas MTB & Enduro",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Morella Singletracks MTB Adventure",
      },
    ],
  },
  twitter: {
