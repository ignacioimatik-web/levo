    ...
    <section className="relative h-[calc(100dvh-128px)] md:h-[calc(100vh-64px)]">
      ...
      <div className="h-12 flex items-center justify-between px-4 bg-slate-950 border-b border-white/[0.04]">
        ...
        <div className="flex items-center gap-1.5">
          <Link
            href="/vista-forfait"
            className="hidden sm:inline-flex items-center gap-1.5 px-2.5 py-1 rounded text-[10px] font-bold uppercase tracking-widest text-slate-400 hover:text-orange-400 border border-white/5 hover:border-orange-500/30 transition-colors"
          >
            ...
            {selectedTrackIds.length > 0 && builtRoute && (
              <div className="absolute top-0 left-0 right-0 px-4 py-1.5 bg-gradient-to-b from-slate-950/90 via-slate-950/70 to-transparent flex items-center justify-between gap-2 pointer-events-none pr-28">
                ...
                <div className="flex items-center gap-1.5 flex-shrink-0 pointer-events-auto">
                  ...
                  <button
                    onClick={clearRoute}
                    className="p-1.5 bg-slate-900/80 hover:bg-red-500/20 text-slate-500 hover:text-red-400 rounded-lg transition-colors backdrop-blur-sm"
                    title="Limpiar ruta"
                  >
