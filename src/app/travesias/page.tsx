    ...
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <section className="relative py-32 px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="w-full h-full bg-[url('https://images.unsplash.com/photo-1551632432-0a7a845599d1?auto=format&fit=crop&q=80&w=2070')] bg-cover bg-center"></div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-slate-900 border border-white/5 rounded-3xl p-16 text-center">
            ...
            <p className="text-slate-400 text-lg max-w-2xl mx-auto leading-relaxed mb-8">
              ...
              Itinerarios que abarcan varios sectores para vivir la experiencia completa de Morella Singletracks.
            </p>
