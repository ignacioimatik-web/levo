    ...
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <section className="relative py-32 px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="w-full h-full bg-[url('https://images.unsplash.com/photo-1633707167682-9068729bc84c?auto=format&fit=crop&q=80&w=2070')] bg-cover bg-center"></div>
        </div>
        <div className="relative z-20 max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Los tramos técnicos, las bajadas más emocionantes y los singletracks más emblemáticos de E-nduro Ebiketracks.
          </p>
        </div>
      </section>
