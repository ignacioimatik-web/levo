      ...
      <section className="relative py-32 px-6 overflow-hidden">
        ...
        <div className="relative z-20 max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
            E-nduro Singletracks surge de la necesidad que tenemos los que vivimos y practicamos mtb en Morella de compartir, gestionar y dar a conocer las rutas que hemos creado a base de pedalear por estos parajes.
          </p>
        </div>
      </section>
